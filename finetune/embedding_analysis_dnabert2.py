#!/usr/bin/env python3
"""
Embedding Analysis Script for DNABERT-2

This script extracts embeddings from DNABERT-2 and evaluates them using:
1. Linear probe (logistic regression)
2. 3-layer neural network
3. Silhouette score for embedding quality
4. PCA visualization

DNABERT-2 uses BPE tokenization and outputs 768-dimensional embeddings.
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Extract embeddings from DNABERT-2 and evaluate for binary classification"
    )
    parser.add_argument(
        "--csv_dir",
        type=str,
...
def main():
    ...
    print("\n" + "=" * 60)
    print("DNABERT-2 Embedding Analysis")
    print("=" * 60)
    ...
    pc1_var, pc2_var = create_pca_visualization(
        ...
        title=f"DNABERT-2 Embeddings PCA (Test Set)"
    )
