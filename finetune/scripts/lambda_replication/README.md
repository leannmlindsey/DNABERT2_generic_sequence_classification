...
sbatch --job-name=smoke_ft_2k_dnabert2_s1 \
  ...
  --export="ALL,REPO_ROOT=${REPO_ROOT},CONDA_ENV=dnabert2_env,REPL_OUTPUT_DIR=${OUT},LAMBDA_DIR=${LAMBDA_DIR},VARIANT=dnabert2,SEED=1,LEN=2k,MAX_LENGTH=512,BASE_MODEL=zhihan1996/DNABERT-2-117M,LR=3e-5,BATCH_SIZE=8,EVAL_BATCH_SIZE=16,NUM_EPOCHS=3,USE_FP16=1" \
