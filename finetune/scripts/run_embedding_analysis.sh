#!/bin/bash
#SBATCH --job-name=dnabert2_emb
#SBATCH --partition=gpu
#SBATCH --gres=gpu:a100:1
#SBATCH --mem=64g
#SBATCH --cpus-per-task=8
#SBATCH --time=4:00:00
#SBATCH --output=dnabert2_emb_%j.out
#SBATCH --error=dnabert2_emb_%j.err

# Biowulf batch script for DNABERT-2 embedding analysis
...
echo "============================================================"
echo "DNABERT-2 Embedding Analysis"
echo "============================================================"
